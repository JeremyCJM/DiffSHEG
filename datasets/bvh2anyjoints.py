...
def transfer2target(ori_list, target_list, ori_path, save_path, target_fps):
    ...
    counter = 0
    save_path = os.path.join(save_path, f'fps{target_fps}')
    ...
    for bvh_file_dir in bvh_files_dirs:
        ...
        # import pdb; pdb.set_trace()
        new_file_name = os.path.basename(bvh_file_dir)
        with open(os.path.join(save_path, new_file_name),'w+') as wirte_file:
...
if __name__ == "__main__":
    ...
    transfer2target(beat_joints, spine_neck_141, '/home/cjm/disk1/datasets/BEAT/selected/train/', '/home/cjm/disk1/datasets/BEAT/processed/train/', target_fps)
    transfer2target(beat_joints, spine_neck_141, '/home/cjm/disk1/datasets/BEAT/selected/val/', '/home/cjm/disk1/datasets/BEAT/processed/val/', target_fps)
    transfer2target(beat_joints, spine_neck_141, '/home/cjm/disk1/datasets/BEAT/selected/test/', '/home/cjm/disk1/datasets/BEAT/processed/test/', target_fps)
    get_mean_pose(f'/home/cjm/disk1/datasets/BEAT/processed/train/fps{target_fps}/')
    
    transfer2target_vis(beat_joints, spine_neck_141, '/home/cjm/disk1/datasets/BEAT/selected/train/', '/home/cjm/disk1/datasets/BEAT/processed/train/vis/', target_fps)
    transfer2target_vis(beat_joints, spine_neck_141, '/home/cjm/disk1/datasets/BEAT/selected/val/', '/home/cjm/disk1/datasets/BEAT/processed/val/vis/', target_fps)
    transfer2target_vis(beat_joints, spine_neck_141, '/home/cjm/disk1/datasets/BEAT/selected/test/', '/home/cjm/disk1/datasets/BEAT/processed/test/vis/', target_fps)
