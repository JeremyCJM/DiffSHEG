...
def print_current_loss(start_time, niter_state, losses, epoch=None, inner_iter=None, mode='train'):
    ...
    if epoch is not None:
        if mode == 'train':
            ...
            print('[Validation] epoch: %3d niter: %6d  inner_iter: %4d' % (epoch, niter_state, inner_iter), end=" ")
